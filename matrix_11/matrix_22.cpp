...
int combine_digits2(int list_of_digits_rec[],int N_iteration,int *matrix_list, int &local_max,int shift){
...
print_array(matrix_list, 12);
	...
	do {
		...
		combine_digits2(matrix_list_copy[nn], list_length, matrix_list1[nn],local_max[nn],0);
		//};
		for (int nn=0;nn<4;nn++){
